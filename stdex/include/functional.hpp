...
#define _STDEX_INVOKE_ELIPSIS_IMPL0(count) _STDEX_INVOKE_IMPL(count, _STDEX_ELIPSIS_TYPE_WITH_COMMA,  _STDEX_ELIPSIS_TMPL_ARGS_WITH_COMMA(7) , _STDEX_ELIPSIS_PARAMS_WITH_COMMA(7), _STDEX_ELIPSIS_ARGS_WITH_COMMA(7)) _STDEX_INVOKE_ELIPSIS_IMPL1(count)
#define _STDEX_INVOKE_ELIPSIS_IMPL1(count) _STDEX_INVOKE_IMPL(count, _STDEX_ELIPSIS_TYPE_WITH_COMMA,  _STDEX_ELIPSIS_TMPL_ARGS_WITH_COMMA(6) , _STDEX_ELIPSIS_PARAMS_WITH_COMMA(6), _STDEX_ELIPSIS_ARGS_WITH_COMMA(6)) _STDEX_INVOKE_ELIPSIS_IMPL2(count)
#define _STDEX_INVOKE_ELIPSIS_IMPL2(count) _STDEX_INVOKE_IMPL(count, _STDEX_ELIPSIS_TYPE_WITH_COMMA,  _STDEX_ELIPSIS_TMPL_ARGS_WITH_COMMA(5) , _STDEX_ELIPSIS_PARAMS_WITH_COMMA(5), _STDEX_ELIPSIS_ARGS_WITH_COMMA(5)) _STDEX_INVOKE_ELIPSIS_IMPL3(count)
#define _STDEX_INVOKE_ELIPSIS_IMPL3(count) _STDEX_INVOKE_IMPL(count, _STDEX_ELIPSIS_TYPE_WITH_COMMA,  _STDEX_ELIPSIS_TMPL_ARGS_WITH_COMMA(4) , _STDEX_ELIPSIS_PARAMS_WITH_COMMA(4), _STDEX_ELIPSIS_ARGS_WITH_COMMA(4)) _STDEX_INVOKE_ELIPSIS_IMPL4(count)
#define _STDEX_INVOKE_ELIPSIS_IMPL4(count) _STDEX_INVOKE_IMPL(count, _STDEX_ELIPSIS_TYPE_WITH_COMMA,  _STDEX_ELIPSIS_TMPL_ARGS_WITH_COMMA(3) , _STDEX_ELIPSIS_PARAMS_WITH_COMMA(3), _STDEX_ELIPSIS_ARGS_WITH_COMMA(3)) _STDEX_INVOKE_ELIPSIS_IMPL5(count)
#define _STDEX_INVOKE_ELIPSIS_IMPL5(count) _STDEX_INVOKE_IMPL(count, _STDEX_ELIPSIS_TYPE_WITH_COMMA,  _STDEX_ELIPSIS_TMPL_ARGS_WITH_COMMA(2) , _STDEX_ELIPSIS_PARAMS_WITH_COMMA(2), _STDEX_ELIPSIS_ARGS_WITH_COMMA(2)) _STDEX_INVOKE_ELIPSIS_IMPL6(count)
#define _STDEX_INVOKE_ELIPSIS_IMPL6(count) _STDEX_INVOKE_IMPL(count, _STDEX_ELIPSIS_TYPE_WITH_COMMA,  _STDEX_ELIPSIS_TMPL_ARGS_WITH_COMMA(1) , _STDEX_ELIPSIS_PARAMS_WITH_COMMA(1), _STDEX_ELIPSIS_ARGS_WITH_COMMA(1)) _STDEX_INVOKE_ELIPSIS_IMPL7(count)
#define _STDEX_INVOKE_ELIPSIS_IMPL7(count) _STDEX_INVOKE_IMPL(count, _STDEX_ELIPSIS_TYPE_WITH_COMMA,  _STDEX_ELIPSIS_TMPL_ARGS_WITH_COMMA(0) , _STDEX_ELIPSIS_PARAMS_WITH_COMMA(0), _STDEX_ELIPSIS_ARGS_WITH_COMMA(0) ) //_STDEX_INVOKE_ELIPSIS_IMPL8(count)
