...
\
    template<_STDEX_TMPL_ARGS##count(/**/, /**/) elipsis_tmpl_args> \
    void invoke( void(*_func)(_STDEX_TYPES##count(/**/, /**/) vargs ), _STDEX_PARAMS##count(typename stdex::detail::_dummy_trait<, >::type, /**/, /**/) elipsis_params)\
    {\
        _func(_STDEX_ARGS##count(/**/, /**/) elipsis_args);\
    }\
\
    template<class _R, class _ObjectT, _STDEX_TMPL_ARGS##count(/**/, /**/) elipsis_tmpl_args>\
    _R invoke( _R(_ObjectT::*_func)(_STDEX_TYPES##count(/**/, /**/) vargs ), _ObjectT &_obj, _STDEX_PARAMS##count(typename stdex::detail::_dummy_trait<, >::type, /**/, /**/) elipsis_params)\
    {\
        return\
        detail::functional_std::_forward<_R>::call(\
...
\
    template<class _ObjectT, _STDEX_TMPL_ARGS##count(/**/, /**/) elipsis_tmpl_args>\
    void invoke( void(_ObjectT::*_func)(_STDEX_TYPES##count(/**/, /**/) vargs ), _ObjectT &_obj, _STDEX_PARAMS##count(typename stdex::detail::_dummy_trait<, >::type, /**/, /**/) elipsis_params)\
    {\
        (_obj.*_func)(_STDEX_ARGS##count(/**/, /**/) elipsis_args);\
    }\
\
    template<class _R, class _ObjectT, _STDEX_TMPL_ARGS##count(/**/, /**/) elipsis_tmpl_args>\
    _R invoke( _R(_ObjectT::*_func)(_STDEX_TYPES##count(/**/, /**/) vargs ) const, const _ObjectT &_obj, _STDEX_PARAMS##count(typename stdex::detail::_dummy_trait<, >::type, /**/, /**/) elipsis_params)\
    {\
        return\
        detail::functional_std::_forward<_R>::call(\
            (_obj.*_func)(_STDEX_ARGS##count(/**/, /**/) elipsis_args) );\
...
\
    template<class _ObjectT, _STDEX_TMPL_ARGS##count(/**/, /**/) elipsis_tmpl_args>\
    void invoke( void(_ObjectT::*_func)(_STDEX_TYPES##count(/**/, /**/) vargs ) const, const _ObjectT &_obj, _STDEX_PARAMS##count(typename stdex::detail::_dummy_trait<, >::type, /**/, /**/) elipsis_params)\
    {\
        (_obj.*_func)(_STDEX_ARGS##count(/**/, /**/) elipsis_args);\
    }\
\
...
\
    template<class _R, class _ObjectT, _STDEX_TMPL_ARGS##count(/**/, /**/) elipsis_tmpl_args>\
    _R invoke( _R(_ObjectT::*_func)(_STDEX_TYPES##count(/**/, /**/) vargs ), reference_wrapper<_ObjectT> &_ref, _STDEX_PARAMS##count(typename stdex::detail::_dummy_trait<, >::type, /**/, /**/) elipsis_params)\
    {\
        return\
        detail::functional_std::_forward<_R>::call(\
...
\
    template<class _ObjectT, _STDEX_TMPL_ARGS##count(/**/, /**/) elipsis_tmpl_args>\
    void invoke( void(_ObjectT::*_func)(_STDEX_TYPES##count(/**/, /**/) vargs ), reference_wrapper<_ObjectT> &_ref, _STDEX_PARAMS##count(typename stdex::detail::_dummy_trait<, >::type, /**/, /**/) elipsis_params)\
    {\
        (_ref.get().*_func)(_STDEX_ARGS##count(/**/, /**/) elipsis_args);\
    }\
\
    template<class _R, class _ObjectT, _STDEX_TMPL_ARGS##count(/**/, /**/) elipsis_tmpl_args>\
    _R invoke( _R(_ObjectT::*_func)(_STDEX_TYPES##count(/**/, /**/) vargs ) const, reference_wrapper<_ObjectT> &_ref, _STDEX_PARAMS##count(typename stdex::detail::_dummy_trait<, >::type, /**/, /**/) elipsis_params)\
    {\
        return\
        detail::functional_std::_forward<_R>::call(\
            (_ref.get().*_func)(_STDEX_ARGS##count(/**/, /**/) elipsis_args) );\
...
\
    template<class _ObjectT, _STDEX_TMPL_ARGS##count(/**/, /**/) elipsis_tmpl_args>\
    void invoke( void(_ObjectT::*_func)(_STDEX_TYPES##count(/**/, /**/) vargs ) const, reference_wrapper<_ObjectT> &_ref, _STDEX_PARAMS##count(typename stdex::detail::_dummy_trait<, >::type, /**/, /**/) elipsis_params)\
    {\
        (_ref.get().*_func)(_STDEX_ARGS##count(/**/, /**/) elipsis_args);\
    }
...
#define _STDEX_INVOKE_ELIPSIS_IMPL0(count) _STDEX_INVOKE_IMPL(count, _STDEX_ELIPSIS_TYPE_WITH_COMMA,  _STDEX_ELIPSIS_TMPL_ARGS_WITH_COMMA(16) , _STDEX_ELIPSIS_PARAMS_WITH_COMMA(16), _STDEX_ELIPSIS_ARGS_WITH_COMMA(16)) _STDEX_INVOKE_ELIPSIS_IMPL1(count)
#define _STDEX_INVOKE_ELIPSIS_IMPL1(count) _STDEX_INVOKE_IMPL(count, _STDEX_ELIPSIS_TYPE_WITH_COMMA,  _STDEX_ELIPSIS_TMPL_ARGS_WITH_COMMA(15) , _STDEX_ELIPSIS_PARAMS_WITH_COMMA(15), _STDEX_ELIPSIS_ARGS_WITH_COMMA(15)) _STDEX_INVOKE_ELIPSIS_IMPL2(count)
#define _STDEX_INVOKE_ELIPSIS_IMPL2(count) _STDEX_INVOKE_IMPL(count, _STDEX_ELIPSIS_TYPE_WITH_COMMA,  _STDEX_ELIPSIS_TMPL_ARGS_WITH_COMMA(14) , _STDEX_ELIPSIS_PARAMS_WITH_COMMA(14), _STDEX_ELIPSIS_ARGS_WITH_COMMA(14)) _STDEX_INVOKE_ELIPSIS_IMPL3(count)
#define _STDEX_INVOKE_ELIPSIS_IMPL3(count) _STDEX_INVOKE_IMPL(count, _STDEX_ELIPSIS_TYPE_WITH_COMMA,  _STDEX_ELIPSIS_TMPL_ARGS_WITH_COMMA(13) , _STDEX_ELIPSIS_PARAMS_WITH_COMMA(13), _STDEX_ELIPSIS_ARGS_WITH_COMMA(13)) _STDEX_INVOKE_ELIPSIS_IMPL4(count)
#define _STDEX_INVOKE_ELIPSIS_IMPL4(count) _STDEX_INVOKE_IMPL(count, _STDEX_ELIPSIS_TYPE_WITH_COMMA,  _STDEX_ELIPSIS_TMPL_ARGS_WITH_COMMA(12) , _STDEX_ELIPSIS_PARAMS_WITH_COMMA(12), _STDEX_ELIPSIS_ARGS_WITH_COMMA(12)) _STDEX_INVOKE_ELIPSIS_IMPL5(count)
#define _STDEX_INVOKE_ELIPSIS_IMPL5(count) _STDEX_INVOKE_IMPL(count, _STDEX_ELIPSIS_TYPE_WITH_COMMA,  _STDEX_ELIPSIS_TMPL_ARGS_WITH_COMMA(11) , _STDEX_ELIPSIS_PARAMS_WITH_COMMA(11), _STDEX_ELIPSIS_ARGS_WITH_COMMA(11)) _STDEX_INVOKE_ELIPSIS_IMPL6(count)
#define _STDEX_INVOKE_ELIPSIS_IMPL6(count) _STDEX_INVOKE_IMPL(count, _STDEX_ELIPSIS_TYPE_WITH_COMMA,  _STDEX_ELIPSIS_TMPL_ARGS_WITH_COMMA(10) , _STDEX_ELIPSIS_PARAMS_WITH_COMMA(10), _STDEX_ELIPSIS_ARGS_WITH_COMMA(10)) _STDEX_INVOKE_ELIPSIS_IMPL7(count)
#define _STDEX_INVOKE_ELIPSIS_IMPL7(count) _STDEX_INVOKE_IMPL(count, _STDEX_ELIPSIS_TYPE_WITH_COMMA,  _STDEX_ELIPSIS_TMPL_ARGS_WITH_COMMA(9)  , _STDEX_ELIPSIS_PARAMS_WITH_COMMA(9) , _STDEX_ELIPSIS_ARGS_WITH_COMMA(9) ) _STDEX_INVOKE_ELIPSIS_IMPL8(count)
#define _STDEX_INVOKE_ELIPSIS_IMPL8(count) _STDEX_INVOKE_IMPL(count, _STDEX_ELIPSIS_TYPE_WITH_COMMA,  _STDEX_ELIPSIS_TMPL_ARGS_WITH_COMMA(8)  , _STDEX_ELIPSIS_PARAMS_WITH_COMMA(8) , _STDEX_ELIPSIS_ARGS_WITH_COMMA(8) ) _STDEX_INVOKE_ELIPSIS_IMPL9(count)
#define _STDEX_INVOKE_ELIPSIS_IMPL9(count) _STDEX_INVOKE_IMPL(count, _STDEX_ELIPSIS_TYPE_WITH_COMMA,  _STDEX_ELIPSIS_TMPL_ARGS_WITH_COMMA(7)  , _STDEX_ELIPSIS_PARAMS_WITH_COMMA(7) , _STDEX_ELIPSIS_ARGS_WITH_COMMA(7) ) _STDEX_INVOKE_ELIPSIS_IMPL10(count)
#define _STDEX_INVOKE_ELIPSIS_IMPL10(count) _STDEX_INVOKE_IMPL(count, _STDEX_ELIPSIS_TYPE_WITH_COMMA, _STDEX_ELIPSIS_TMPL_ARGS_WITH_COMMA(6)  , _STDEX_ELIPSIS_PARAMS_WITH_COMMA(6) , _STDEX_ELIPSIS_ARGS_WITH_COMMA(6) ) _STDEX_INVOKE_ELIPSIS_IMPL11(count)
#define _STDEX_INVOKE_ELIPSIS_IMPL11(count) _STDEX_INVOKE_IMPL(count, _STDEX_ELIPSIS_TYPE_WITH_COMMA, _STDEX_ELIPSIS_TMPL_ARGS_WITH_COMMA(5)  , _STDEX_ELIPSIS_PARAMS_WITH_COMMA(5) , _STDEX_ELIPSIS_ARGS_WITH_COMMA(5) ) _STDEX_INVOKE_ELIPSIS_IMPL12(count)
#define _STDEX_INVOKE_ELIPSIS_IMPL12(count) _STDEX_INVOKE_IMPL(count, _STDEX_ELIPSIS_TYPE_WITH_COMMA, _STDEX_ELIPSIS_TMPL_ARGS_WITH_COMMA(4)  , _STDEX_ELIPSIS_PARAMS_WITH_COMMA(4) , _STDEX_ELIPSIS_ARGS_WITH_COMMA(4) ) _STDEX_INVOKE_ELIPSIS_IMPL13(count)
#define _STDEX_INVOKE_ELIPSIS_IMPL13(count) _STDEX_INVOKE_IMPL(count, _STDEX_ELIPSIS_TYPE_WITH_COMMA, _STDEX_ELIPSIS_TMPL_ARGS_WITH_COMMA(3)  , _STDEX_ELIPSIS_PARAMS_WITH_COMMA(3) , _STDEX_ELIPSIS_ARGS_WITH_COMMA(3) ) _STDEX_INVOKE_ELIPSIS_IMPL14(count)
#define _STDEX_INVOKE_ELIPSIS_IMPL14(count) _STDEX_INVOKE_IMPL(count, _STDEX_ELIPSIS_TYPE_WITH_COMMA, _STDEX_ELIPSIS_TMPL_ARGS_WITH_COMMA(2)  , _STDEX_ELIPSIS_PARAMS_WITH_COMMA(2) , _STDEX_ELIPSIS_ARGS_WITH_COMMA(2) ) _STDEX_INVOKE_ELIPSIS_IMPL15(count)
#define _STDEX_INVOKE_ELIPSIS_IMPL15(count) _STDEX_INVOKE_IMPL(count, _STDEX_ELIPSIS_TYPE_WITH_COMMA, _STDEX_ELIPSIS_TMPL_ARGS_WITH_COMMA(1)  , _STDEX_ELIPSIS_PARAMS_WITH_COMMA(1) , _STDEX_ELIPSIS_ARGS_WITH_COMMA(1) ) _STDEX_INVOKE_ELIPSIS_IMPL16(count)
#define _STDEX_INVOKE_ELIPSIS_IMPL16(count) _STDEX_INVOKE_IMPL(count, _STDEX_ELIPSIS_TYPE_WITH_COMMA, _STDEX_ELIPSIS_TMPL_ARGS_WITH_COMMA(0)  , _STDEX_ELIPSIS_PARAMS_WITH_COMMA(0) , _STDEX_ELIPSIS_ARGS_WITH_COMMA(0) ) //_STDEX_INVOKE_ELIPSIS_IMPL17(count)
...
#define _STDEX_PARAMS_ARG_POSTFIX(count) ))
                    _STDEX_PARAMS_MAX(template make <, >, /**/, /**/)
#undef _STDEX_DELIM
#define _STDEX_DELIM _STDEX_DELIM_DEFAULT
#undef _STDEX_PARAMS_TYPE_PREFIX
#undef _STDEX_PARAMS_TYPE_POSTFIX
