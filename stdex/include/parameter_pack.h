...
#define _STDEX_MACRO_CONCAT(prefix, value,  postfix) _STDEX_MACRO_CONCAT1(prefix, value,  postfix)
...
#define _STDEX_TMPL_ARGS_MAX \
    _STDEX_MACRO_CONCAT(_STDEX_TMPL_ARGS, STDEX_FUNCTION_MAX_ARG_N, _STDEX_BLANK)
#define _STDEX_TYPES_MAX \
    _STDEX_MACRO_CONCAT(_STDEX_TYPES, STDEX_FUNCTION_MAX_ARG_N, _STDEX_BLANK)
#define _STDEX_PARAMS_MAX \
    _STDEX_MACRO_CONCAT(_STDEX_PARAMS, STDEX_FUNCTION_MAX_ARG_N, _STDEX_BLANK)
#define _STDEX_ARGS_MAX \
    _STDEX_MACRO_CONCAT(_STDEX_ARGS, STDEX_FUNCTION_MAX_ARG_N, _STDEX_BLANK)
