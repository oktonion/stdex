...
#define _STDEX_TMPL_ARGS_IMPL(prefix, N, postfix) class prefix _STDEX_PARAMS_TYPE(N) postfix
#define _STDEX_TYPES_IMPL(prefix, N, postfix) prefix _STDEX_PARAMS_TYPE(N) postfix
#define _STDEX_PARAMS_IMPL(prefix1, prefix2, N, postfix1, postfix2) prefix1 _STDEX_PARAMS_TYPE_PREFIX(N) _STDEX_PARAMS_TYPE(N) _STDEX_PARAMS_TYPE_POSTFIX(N) postfix1 prefix2 _STDEX_PARAMS_ARG_PREFIX(N) _STDEX_PARAMS_ARG(N) _STDEX_PARAMS_ARG_POSTFIX(N) postfix2
#define _STDEX_ARGS_IMPL(prefix, N, postfix) prefix _STDEX_PARAMS_ARG(N) postfix
...
#define _STDEX_PARAMS_TYPE(N) _STDEX_PARAMS_TYPE_DEFAULT(N)
#define _STDEX_PARAMS_ARG(N)  _STDEX_PARAMS_ARG_DEFAULT(N)
