...
#define _STDEX_MACRO_CONCAT_IMPL(prefix, value, postfix) prefix##value##postfix
#define _STDEX_MACRO_CONCAT2_IMPL(prefix, value) prefix##value
#define _STDEX_MACRO_CONCAT(prefix, value, postfix) _STDEX_MACRO_CONCAT_IMPL(prefix, value, postfix)
#define _STDEX_MACRO_CONCAT2(prefix, value) _STDEX_MACRO_CONCAT2_IMPL(prefix, value)

#define _STDEX_TMPL_ARGS_MAX_IMPL \
    _STDEX_MACRO_CONCAT(_STDEX_TMPL_ARGS, STDEX_FUNCTION_MAX_ARG_N, _IMPL)
#define _STDEX_TYPES_MAX_IMPL \
    _STDEX_MACRO_CONCAT(_STDEX_TYPES, STDEX_FUNCTION_MAX_ARG_N, _IMPL)
#define _STDEX_PARAMS_MAX_IMPL \
    _STDEX_MACRO_CONCAT(_STDEX_PARAMS, STDEX_FUNCTION_MAX_ARG_N, _IMPL)
#define _STDEX_ARGS_MAX_IMPL \
    _STDEX_MACRO_CONCAT(_STDEX_ARGS, STDEX_FUNCTION_MAX_ARG_N, _IMPL)

#define _STDEX_REPEAT_TOKEN_MAX _STDEX_REPEAT_TOKEN##16
#define _STDEX_TMPL_ARGS_MAX \
    _STDEX_MACRO_CONCAT2(_STDEX_TMPL_ARGS, STDEX_FUNCTION_MAX_ARG_N)
#define _STDEX_TYPES_MAX \
    _STDEX_MACRO_CONCAT2(_STDEX_TYPES, STDEX_FUNCTION_MAX_ARG_N)
#define _STDEX_PARAMS_MAX \
    _STDEX_MACRO_CONCAT2(_STDEX_PARAMS, STDEX_FUNCTION_MAX_ARG_N)
#define _STDEX_ARGS_MAX \
    _STDEX_MACRO_CONCAT2(_STDEX_ARGS, STDEX_FUNCTION_MAX_ARG_N)
...
#undef _STDEX_MACRO_CONCAT1
#undef _STDEX_MACRO_CONCAT
