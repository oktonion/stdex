...
class _system_error{
    ...
    struct _hidden;
    friend inline void make_error_code(_hidden&);
    friend inline void make_error_condition(_hidden&);
};

inline void make_error_code(_system_error::_hidden&){}
inline void make_error_condition(_system_error::_hidden&){}
